...
public class UserService {
    ...
    public User updateUser(int userId, String username, String email, String password, String profileImg) {
        ...
        try (Connection conn = getConnection();
            ...
            if (username != null) stmt.setString(parameterIndex++, username);
            if (email != null) stmt.setString(parameterIndex++, email);
            if (password != null) stmt.setString(parameterIndex++, password);
            if (profileImg != null) stmt.setString(parameterIndex++, profileImg);
